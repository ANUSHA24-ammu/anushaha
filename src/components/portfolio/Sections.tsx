...
const projects: Project[] = [
  ...
  { title: "SubSchool — App", cat: "Apps", client: "School management platform", desc: "Parent and teacher mobile app for the SubSchool platform.", problem: "Parents and teachers needed the school platform in their pocket, with instant updates instead of logging into a browser.", solution: "Built a cross-platform mobile app sharing the same APIs as the web platform: attendance marking, homework and timetable views, fee status, exam results, push notifications and direct parent-teacher messaging.", result: "Daily school updates reach parents instantly and teachers mark attendance in seconds from their phones.", tech: ["React Native", "REST API", "Push notifications", "Offline-friendly UI"], url: "https://subschool.in", img: "https://images.unsplash.com/photo-1596495578065-6e0763fa1178?w=1200&q=80" },
